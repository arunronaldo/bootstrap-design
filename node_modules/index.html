        ...
        <div class="d-sm-flex align-items-center justify-content-between">
            <div>
                ...
                <p class="lead my-4">
                 ...
                 <button class="btn btn-primary btn-lg" data-bs-toggle="modal" data-bs-target="#enroll">Start the Enrolement</button>
            </div>
                    ...
                    <div class="card-body text-center">
                        ...
                        <P class="card-text">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit.
                             Neque explicabo maiores doloremque corporis debitis iure!
                        </P>
    ...
    <div class="container">
        <div class="row align-items-center justify-content-between">
         ...
         <div class="col-md p-5">
             ...
             <p class="lead">
                 Lorem ipsum dolor sit amet consectetur adipisicing elit. 
                 Officiis accusamus eaque temporibus repellendus dolorum suscipit!
             </p>
             <p>
                 Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quisquam nesciunt atque quidem quo dignissimos rerum deserunt,
                 reprehenderit cum ullam fuga non dolor pariatur dicta velit explicabo. Quas, eveniet. Vero, molestias!
             </p>
    ...
    <div class="container">
        <div class="row align-items-center justify-content-between">
         ...
         <div class="col-md p-5">
             ...
             <div class="col-md">
                <img src="./img/undraw_react_y-7-wq.svg" class="img-fluid" alt="">
            </div>
        </div>
    </div>
</section>
...
<div class="p-5">
    <div class="container">
            ...
            <div class="accordion-item">
              ...
              <div id="question-one" class="accordion-collapse collapse"  data-bs-parent=#question>
                <div class="accordion-body">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit hic libero obcaecati tenetur quos dolorem maxime ducimus. Laudantium maxime rem, beatae reprehenderit 
                    aliquam expedita et deserunt error veniam rerum repellat impedit unde temporibus sit iste ducimus adipisci doloremque doloribus! Officiis sapiente atque modi, dolorum alias repellat nostrum ab omnis eveniet.
                </div>
              </div>
            </div>
            </div>
        ...
        <div class="accordion-item">
                ...
                <div id="question-four" class="accordion-collapse collapse"  data-bs-parent=#question>
                  <div class="accordion-body">
                      Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit hic libero obcaecati tenetur quos dolorem maxime ducimus. Laudantium maxime rem, beatae reprehenderit 
                      aliquam expedita et deserunt error veniam rerum repellat impedit unde temporibus sit iste ducimus adipisci doloremque doloribus! Officiis sapiente atque modi, dolorum alias repellat nostrum ab omnis eveniet.
                  </div>
              ...
              <div class="card bg-light">
                  <div class="card-body text-center">
                      ...
                      <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. 
                          Ab natus error nostrum corporis possimus aspernatur!</p>
              ...
              <div class="col-md-6 col-lg-3">
                <div class="card bg-light">
                    <div class="card-body text-center">
                        ...
                        <h3 class="card-title mb-3">Lara</h3>
                        <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. 
                            Ab natus error nostrum corporis possimus aspernatur!</p>
                            <a href="#"><i class="bi bi-twitter text-dark mx-1"></i></a>
                            <a href="#"><i class="bi bi-facebook text-dark mx-1"></i></a>
        ...
        <div class="row g-4">
            <div class="col-md">
                ...
                <ul class="list-group list-group-flush lead">
                    ...
                    <li class="list-group-item">
                        <span class="fw-bold">Enrollement Phone:</span> (555) 555-5555
                    </li>
                    <li class="list-group-item">
                        <span class="fw-bold">Student Phone:</span> (333) 333-3333
                    </li>
                    <li class="list-group-item">
                        <span class="fw-bold">Enrollement E-mail:</span>(555) enroll@frontendbc.test
                    </li>
                    <li class="list-group-item">
                        <span class="fw-bold">Student E-mail:</span> student@frontendbc.test
                    </li>
                </ul>
...
<script>
    mapboxgl.accessToken = 'pk.eyJ1IjoiYXJ1bi1yb25hbGRvLTA3IiwiYSI6ImNrd3hpamJqYjBlNHEycXF0cTQ0cTFkZGgifQ.dUGiLdovnVI6SD0iqkoNCA';
...
<footer class="p-5 bg-dark text-white text-center position-relative">
    <div class="continer">
        ...
        <a href="#" class="position-absolute bottom-0 end-0 p-5">
            <i class="bi bi-arrow-up-circle f1"></i>
        </a>
    </div>
